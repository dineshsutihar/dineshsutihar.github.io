    ...
    return (
        ...
        <section className="max-w-7xl mx-auto px-4 py-8">
            ...
            <ol className="relative border-s border-gray-200 dark:border-gray-700 mt-10 ">
                {details.map((item) => (
                    <li key={item.id} className="mb-10 ms-6 opacity-60  hover:opacity-100 transition-opacity duration-300 cursor-default">
                        ...
                        <div className="flex items-baseline justify-between w-full">
                            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 italic">{item.course}</p>
                            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 italic">{item?.percentage || item?.cgpa}</p>
                        </div>
